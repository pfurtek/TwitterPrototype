...
class UserinfoSectionController: IGListSectionController, IGListSectionType, IGListWorkingRangeDelegate {
    ...
    func cellForItem(at index: Int) -> UICollectionViewCell {
        let cell = collectionContext!.dequeueReusableCell(withNibName: "UserinfoCollectionViewCell", bundle: nil, for: self, at: index) as! UserinfoCollectionViewCell
